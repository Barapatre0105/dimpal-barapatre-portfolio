        ...
        <div className="glass-panel rounded-3xl p-8 md:p-16 grid grid-cols-1 md:grid-cols-2 gap-12 relative overflow-hidden">
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="mailto:dimplebarapatre2018@gmail.com" className="flex items-center gap-4 text-gray-300 hover:text-[#00f0ff] transition-colors">
                <div className="p-3 bg-[#111] rounded-full border border-gray-700"><Mail size={20} /></div>
                <span>dimplebarapatre2018@gmail.com</span>
              </a>
              <a href="https://www.linkedin.com/in/dimpal-barapatre-250745423" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-gray-300 hover:text-[#b026ff] transition-colors">
                <div className="p-3 bg-[#111] rounded-full border border-gray-700"><Globe size={20} /></div>
                <span>LinkedIn Profile</span>
              </a>
              <a href="https://github.com/Barapatre0105" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors">
                <div className="p-3 bg-[#111] rounded-full border border-gray-700"><Code size={20} /></div>
                <span>github.com/Barapatre0105</span>
              </a>
